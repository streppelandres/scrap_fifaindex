...
def get_and_download_team_img(driver, team_id):
    ...
    # https://www.fifaindex.com/static/FIFA17/images/crest/10/light/21.webp
    
    # img_src = img_src.replace(".webp", ".png") #img_src[0:len(img_src)-4] + "png" # Cambio el formato a png
    print("-----------> " + os.getcwd())
    urllib.request.urlretrieve(img_src, "img/team/" + team_id + "/" + team_id + ".png")

def get_and_download_team_kits(driver, team_id):
    kit_web_element_list = driver.find_element_by_css_selector("div.col-12.col-lg-7 div.card.mb-5 div.card-body div.row div.col-6.text-center")
    ...
    for we_kit in kit_web_element_list:
        ...
        we_p = we_kit.find_element_by_css_selector("p")
